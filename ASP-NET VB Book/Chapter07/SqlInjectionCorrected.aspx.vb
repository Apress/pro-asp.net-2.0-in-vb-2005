...
Public partial Class SqlInjectionCorrected : Inherits System.Web.UI.Page
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)

	End Sub
	Protected Sub cmdGetRecords_Click(ByVal sender As Object, ByVal e As System.EventArgs)
