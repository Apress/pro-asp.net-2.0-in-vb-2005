...
Imports Resources.ValidationResources
...
Public partial Class Default_aspx : Inherits System.Web.UI.Page
    ...
    End Sub
	Protected Sub OkayAction_Click(ByVal sender As Object, ByVal e As EventArgs)
	  Response.Write(Me.GetLocalResourceObject("LabelResource1.Text"))
    End Sub
