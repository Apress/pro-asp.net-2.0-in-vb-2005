...
Public partial Class TableContentPage_aspx : Inherits System.Web.UI.Page
	...
	End Sub
	Protected Sub cmdHide_Click(ByVal sender As Object, ByVal e As EventArgs)
		Dim master As TableMaster_master = CType(Me.Master, TableMaster_master)
